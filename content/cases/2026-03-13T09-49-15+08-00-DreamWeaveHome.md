...
<img src="{{< baseurl "images/DreamWeaveHome-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/DreamWeaveHome.html" >}}" width="100%" height="600" frameborder="0"></iframe>
