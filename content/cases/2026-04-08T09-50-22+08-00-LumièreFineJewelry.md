...
<img src="{{< baseurl "images/LumièreFineJewelry-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/LumièreFineJewelry.html" >}}" width="100%" height="600" frameborder="0"></iframe>
