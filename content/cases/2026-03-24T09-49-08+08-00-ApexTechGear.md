...
<img src="{{< baseurl "images/ApexTechGear-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/ApexTechGear.html" >}}" width="100%" height="600" frameborder="0"></iframe>
