...
[
  {
    ...
    "url": "{{< baseurl "cases/2026-05-02T09-50-16+08-00-HopCraftBrewers/" >}}",
    "mainEntityOfPage": "{{< baseurl "cases/2026-05-02T09-50-16+08-00-HopCraftBrewers/" >}}",
    "image": "/images/HopCraftBrewers-hero.jpg",
...
<img src="{{< baseurl "images/HopCraftBrewers-dash.jpg" >}}" width="80%" alt="dashboard">
...
![HopCraft Brewers storefront showing personalized craft beer recommendations](<img src="{{< baseurl "images/HopCraftBrewers-dash.jpg" >}}" width="80%" alt="dashboard">)
...
<iframe src="{{< baseurl "charts/HopCraftBrewers.html" >}}" width="100%" height="600" frameborder="0"></iframe>
