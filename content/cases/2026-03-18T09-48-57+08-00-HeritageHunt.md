...
<img src="{{< baseurl "images/HeritageHunt-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/HeritageHunt.html" >}}" width="100%" height="600" frameborder="0"></iframe>
