...
<img src="{{< baseurl "images/TinyRideStrollers-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/TinyRideStrollers.html" >}}" width="100%" height="600" frameborder="0"></iframe>
