...
<img src="{{< baseurl "images/FocalPointImaging-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/FocalPointImaging.html" >}}" width="100%" height="600" frameborder="0"></iframe>
