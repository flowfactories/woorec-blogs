...
<img src="{{< baseurl "images/LumièreJewel-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/LumièreJewel.html" >}}" width="100%" height="600" frameborder="0"></iframe>
