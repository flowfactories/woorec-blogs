...
<img src="{{< baseurl "images/LuxeLocksWigs-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/LuxeLocksWigs.html" >}}" width="100%" height="600" frameborder="0"></iframe>
