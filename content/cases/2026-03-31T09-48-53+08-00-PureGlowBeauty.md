...
<img src="{{< baseurl "images/PureGlowBeauty-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/PureGlowBeauty.html" >}}" width="100%" height="600" frameborder="0"></iframe>
