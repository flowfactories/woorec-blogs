...
<img src="{{< baseurl "images/PrecisionTailor-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/PrecisionTailor.html" >}}" width="100%" height="600" frameborder="0"></iframe>
