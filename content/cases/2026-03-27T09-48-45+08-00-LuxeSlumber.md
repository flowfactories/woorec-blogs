...
<img src="{{< baseurl "images/LuxeSlumber-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/LuxeSlumber.html" >}}" width="100%" height="600" frameborder="0"></iframe>
