...
<img src="{{< baseurl "images/VelocityCustoms-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/VelocityCustoms.html" >}}" width="100%" height="600" frameborder="0"></iframe>
