...
<img src="{{< baseurl "images/ShellShieldCases-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/ShellShieldCases.html" >}}" width="100%" height="600" frameborder="0"></iframe>
