...
<img src="{{< baseurl "images/VelocityCyclePro-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/VelocityCyclePro.html" >}}" width="100%" height="600" frameborder="0"></iframe>
