...
<img src="{{< baseurl "images/ApexAutoCustoms-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/ApexAutoCustoms.html" >}}" width="100%" height="600" frameborder="0"></iframe>
