...
<img src="{{< baseurl "images/BeanCraftRoasters-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/BeanCraftRoasters.html" >}}" width="100%" height="600" frameborder="0"></iframe>
