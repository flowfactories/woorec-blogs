...
<img src="{{< baseurl "images/BeanVoyageCoffee-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/BeanVoyageCoffee.html" >}}" width="100%" height="600" frameborder="0"></iframe>
