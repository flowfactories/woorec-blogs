...
<img src="{{< baseurl "images/PetitePerfect-dash.jpg" >}}" width="80%" alt="dashboard">
...
<iframe src="{{< baseurl "charts/PetitePerfect.html" >}}" width="100%" height="600" frameborder="0"></iframe>
